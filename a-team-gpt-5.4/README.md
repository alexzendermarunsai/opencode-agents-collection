...
A GPT-5.4-optimized variant of `a-team` for planning, discovery, design, implementation, validation, and documentation.

## What It Is

`a-team-gpt-5.4` keeps the same specialist agent roster as `a-team`, but pairs it with a GPT-5.4-tuned orchestrator and GPT-5.4-focused pack guidance.
...
Use `a-team-gpt-5.4` when:

- you want the lean `a-team` specialist set with a GPT-5.4-tuned orchestrator
