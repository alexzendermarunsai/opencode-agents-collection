...
A fully DeepSeek-native structured-prompt variant of `a-team-plus` for planning, discovery, design, implementation, validation, deployment, performance, security, accessibility, AI work, and documentation.
